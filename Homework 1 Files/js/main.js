...
//Draw text here
 var theCanvas5 = document.getElementById('Canvas5');
				if (theCanvas5 && theCanvas5.getContext) {
					...
					if(ctx5) { 
                        var theString = "Every Villian is Lemons";
...
var theCanvas6 = document.getElementById('Canvas6');
				if (theCanvas6 && theCanvas6.getContext) {
					...
					if(ctx6) {
                        ...
                        ctx6.drawImage(srcImg, 0, 0, 250, 150);
                        
                        ctx6.drawImage(srcImg, 0, 150, 125, 75);
                        
                        ctx6.drawImage(srcImg, 290, 180, 745, 285, 0, 300, 248.3, 95);
